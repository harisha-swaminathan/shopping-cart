export const storeProducts = [
  ...
  },
  {
   ...
   // Coding From The Ground Up",
    ...
    description: "JavaScript is one of the most common and powerful computer languages around. It is easy to use, easy to understand, and is the driving force behind some of the most popular websites around. Facebook uses it. Google uses it. Netflix uses it, and yes --- even Amazon uses it. Would you like to learn how to use it?",
    inCart: false,
    count: 0,
    total: 18
  },
